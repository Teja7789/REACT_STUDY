...
import Main from './src/FoodSwiggyAppBuild/Main'
import MainIndex from "./src/FoodSwiggyAppBuild/SwiggyFoodApp/MainIndex";
import './src/FoodSwiggyAppBuild/SwiggyFoodApp/MainIndex.css';
const App = () => (
    <>
        <Main />
    </>
...
const AppCard = (props) => {
    // console.log(props,'az');
    const {restaurantName , restaurantCuisines,restaurantCostForTwo,restaurantImageId} = props;
...
<section class="cards">
    ...
    <article class="card">
        <img src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" + restaurantImageId} alt="No Img"/>
        <p>{restaurantName}</p>
        <p>{restaurantCuisines.join(",")}</p>
        <p>{restaurantCostForTwo/100}</p>
    </article>
...
const AppLayout = () => (
    <>
        ...
        {resList.map((restaurant) => {
            return(
                <AppCard key={restaurant.data.id} restaurantName={restaurant.data.name}
                restaurantCuisines={restaurant.data.cuisines}
                restaurantCostForTwo={restaurant.data.costForTwo}
                restaurantImageId={restaurant.data.cloudinaryImageId}
                />
            )
        })}
